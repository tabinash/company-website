  ...
  return (
    <div className="bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10 py-8 sm:py-10 md:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
            <div>
              ...
              <div className="mt-5 sm:mt-6 space-y-3 sm:space-y-4 text-gray-700 text-sm sm:text-base md:text-lg leading-relaxed">
                <p>
            ...
            <div className="relative">
              ...
              {/* Hide decorative element on mobile - no value, just clutter */}
              <div className="hidden sm:block absolute -bottom-4 -right-4 w-20 h-20 md:w-24 md:h-24 bg-[#FFB800] rounded-2xl -z-10 opacity-20" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50">
        <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10 py-8 sm:py-10 md:py-12 lg:py-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            {[
              ...
              {
                icon: <Lightbulb className="size-5 sm:size-6" />,
              ...
              <div key={idx} className="rounded-xl sm:rounded-2xl bg-white p-5 sm:p-6 shadow-lg hover:shadow-xl transition-shadow">
                <div className="grid place-items-center size-12 sm:size-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-[#0c2a7a] to-[#1445cc] text-white mb-3 sm:mb-4 shadow-md">
                  {item.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10 py-8 sm:py-10 md:py-12 lg:py-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
            {[
              ...
              <div key={idx} className="rounded-xl sm:rounded-2xl bg-gray-50 p-5 sm:p-6 md:p-8 shadow-lg">
                <div className="text-5xl sm:text-6xl font-extrabold text-[#FFB800] opacity-20 mb-3 sm:mb-4">
                  {step.num}
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-neutral-900 mb-2 sm:mb-3">{step.title}</h3>
                <p className="text-xs sm:text-sm md:text-base text-gray-700 leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10 py-8 sm:py-10 md:py-12 lg:py-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="hidden sm:block absolute -bottom-4 -left-4 w-20 h-20 md:w-24 md:h-24 bg-[#FFB800] rounded-2xl -z-10 opacity-20" />
            </div>

            <div className="order-1 lg:order-2">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-neutral-900 leading-tight">
                Benefits You'll See
              </h2>
              ...
              <div className="mt-5 sm:mt-6 space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-2 sm:gap-3">
                    <div className="mt-0.5 grid place-items-center size-5 sm:size-6 rounded-full bg-[#FFB800] flex-shrink-0">
                      <Check className="size-3 sm:size-4 text-neutral-900" />
                    </div>
                    <p className="text-gray-700 text-sm sm:text-base md:text-lg">{benefit}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10 py-8 sm:py-10 md:py-12 lg:py-14">
          <div className="relative rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#0c2a7a] via-[#0e36a2] to-[#1445cc] overflow-hidden shadow-2xl">
            <div
              className="pointer-events-none absolute right-0 top-0 h-[140%] w-[60%] -translate-y-1/5 translate-x-1/6 rounded-full"
              style={{
                background: 'radial-gradient(closest-side, rgba(255,255,255,0.10), rgba(255,255,255,0.0) 70%)'
            ...
            <div className="relative px-5 sm:px-6 md:px-10 lg:px-14 py-10 sm:py-12 lg:py-16 text-white text-center">
              ...
              <div className="mt-6 sm:mt-8">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center gap-3 sm:gap-4 rounded-full bg-white text-[#0f2f99] font-semibold px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base shadow-[0_10px_30px_rgba(0,0,0,0.15)] hover:brightness-[0.98] transition w-full sm:w-auto"
                >
                  GET STARTED
                  <span className="grid place-items-center rounded-full bg-[#FFB800] text-[#0e254f] size-9 sm:size-10 shadow-[0_6px_16px_rgba(255,184,0,0.45)]">
